...
public class DayOne implements Exercise<Integer, Integer> {
    static class CircularDail {
        ...
        static int countOccurrenceOfZeroLocationAfterRotation(int currentPosition, List<String> rotations) {
    ...
    public Integer partOne() {
        ...
        return CircularDail.countOccurrenceOfZeroLocationAfterRotation(50, instructions);
    }
